function onMove(cid, fromPosition, toPosition)
     if isPlayer(cid) then
		...
		-- if getPlayerStorageValue(cid, 65008) <= 100 then
			-- setPlayerStorageValue(cid, 65008, getPlayerStorageValue(cid, 65008)+ 1)
			-- doPlayerSendTextMessage(cid, 27, "Você ganhou concluiu 1 passo para chocar o ovo" .. getPlayerStorageValue(cid, 65008) .. "/" .. 100)
			-- return true
		-- end
