...
local pokemons = {
{name = "Rapidash", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Ninetales", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Flareon", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Arcanine", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Charizard", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Magmar", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "normal"},
}
...
local function doSummonGymPokemon(npc)
	...
	pokeSourceCode = doCreateMonsterNick(this, it.name, it.name, getThingPos(this), true)
