...
local pokemons = {
{name = "Cloyster", optionalLevel = 200, sex = SEX_MALE, nick = "Crusher", ball = "poke"},
{name = "Lapras", optionalLevel = 200, sex = SEX_FEMALE, nick = "Laura", ball = "poke"},
{name = "Electabuzz", optionalLevel = 200, sex = SEX_MALE, nick = "Eletron", ball = "poke"},
{name = "Pinsir", optionalLevel = 200, sex = SEX_MALE, nick = "Headcutter", ball = "poke"},
{name = "Dragonair", optionalLevel = 200, sex = SEX_FEMALE, nick = "Dragonix", ball = "poke"},
}
