...
if getPlayerLookDir(summon) == getPlayerLookDir(cid) then 
	return true
end
...
doCreatureSay(cid, ""..getPokeName(getCreatureSummons(cid)[1])..", turn "..dirs[words].dire.."!", TALKTYPE_MONSTER)  --alterado v1.7
