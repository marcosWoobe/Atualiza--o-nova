local poke = {"Gardevoir", "Shiny Gardevoir", "Espeon", "Shiny Xatu", "Jynx", "Shiny Jynx", "Xatu", "Natu", "Exeggutor", "Slowking", "Slowbro", "Shiny Mr. Mime", 'Mew', 'Mewtwo', 'Abra', 'Kadabra', 'Alakazam', 'Drowzee', 'Hypno', 'Mr. Mime', 'Porygon', 'Shiny Abra', 'Shiny Alakazam', 
...
[11] = {name = "phenac", id = 11, level = 250, pos = {x=2228,y=520,z=7}},
[12] = {name = "agate", id = 12, level = 250, pos = {x=2198,y=689,z=5}},
}
