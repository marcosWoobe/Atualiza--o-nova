      ...
      if party[#party] == cid then
         ...
         for i = 1, #party do
             if sto >= 1 then
                ...
                doPlayerSendTextMessage(party[i], 27, "The experience share in party is now disabled!")
             else
                setPlayerStorageValue(party[i], 4875498, 1)
                doPlayerSendTextMessage(party[i], 27, "The experience share in party is now enabled!")
             end
         end
      else
