...
function finishDeathmatch()
	...
	for i,pid in pairs(winners) do
		...
		doTeleportThing(pid, {x=997,y=1003,z=7})
...
function onSay(cid, words, param, channel)
	...
	doBroadcastMessage("A deathmatch event is starting in ".. starttime .." minutes, the teleport to the arena has been created. At least ".. minplayers .." are needed for the battle to start. The winner will receive ".. prizecount .." honored tokens.")
	doCreateTeleport(1387,{x=2433,y=2632,z=8},{x=1004,y=999,z=7})
	doSendAnimatedText({x=1004,y=999,z=7}, "DEATHMATCH!", COLOR_BURN)
