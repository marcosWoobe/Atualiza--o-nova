...
class LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaDoConditionAreaHealth(lua_State* L);
		static int32_t luaGetCreaturesInArea(lua_State* L);
		...
		static int32_t luaDoMoveCreatureToPos(lua_State* L);
		static int32_t luaCanMoveToPos(lua_State* L);
		
		static int32_t luaSetCreatureTargetDistance(lua_State* L);
		static int32_t luaGetCreatureTargetDistance(lua_State* L);
		static int32_t luaGetCreatureDefaultTargetDistance(lua_State* L);		
		
		static int32_t luagetPlayerCap(lua_State* L);
		static int32_t luasetPlayerCap(lua_State* L);
		
		static int32_t luasendReloginWindow(lua_State* L);
		static int32_t luadoKillWildPokemon(lua_State* L);
		static int32_t luadoPokemonSetNoTarget(lua_State* L);
		static int32_t luaSetCreatureName(lua_State* L);
		static int32_t luagetNPCXMLNAME(lua_State* L);
		static int32_t luaIsPartyEnabledExp(lua_State* L);
		static int32_t luaDoSendMsgToPartyChannel(lua_State* L);
		static int32_t luaIsPartyEquals(lua_State* L);
		...
		static int32_t luadoMosterSetAttackSpeed(lua_State* L);
		static int32_t luadoCreatureRemoveHealth(lua_State* L);
		static int32_t luadoKillCreature(lua_State* L);
		static int32_t luaGetCreatureNick(lua_State* L);
		static int32_t luaOpenChannelDialog(lua_State* L);
		static int32_t luaDoCreatureSetShieldType(lua_State* L);

		static int32_t luaDoRemoveSummon(lua_State* L);
